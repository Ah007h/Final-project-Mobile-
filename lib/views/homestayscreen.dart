              ...
              : Column(
                  children: [
                    Padding(
                      ...
                      child: Text(
                        "Current Rooms Availables (${productList.length} found)",
                        style: const TextStyle(
                            fontSize: 16,
                              ...
                              child: Column(children: [
                                ...
                                Flexible(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    fit: BoxFit.cover,
                                    imageUrl:
                                        "${ServerConfig.SERVER}assets/productimages/${productList[index].homestayId}.png",
...
//check permission,get location,get address return false if any problem.
  ...
  Future<void> _showDetails(int index) async {
    HomeStay homeStay = HomeStay.fromJson(productList[index].toJson());
  ...
  void _deleteProduct(index) {
    try {
      http.post(Uri.parse("${ServerConfig.SERVER}php/delete_homestay.php"),
          body: {
            "homestayid": productList[index].homestayId,
          }).then((response) {
